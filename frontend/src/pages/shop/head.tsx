...
const HeadSection = () => {
    return (
        <div
            className="relative h-[50vh] md:h-[65vh] bg-cover bg-center bg-no-repeat flex items-center justify-center"
            style={{
        ...
        >
            ...
            <div className="relative z-10 text-center">
                <h1 className="text-2xl md:text-5xl mb-4">Shop</h1>
                <p className="text-sm flex justify-center">
                    <span className="md:text-xl">Home</span>
                    <img className="w-4 md:w-6 md:mx-1" src={arrowRight} />
